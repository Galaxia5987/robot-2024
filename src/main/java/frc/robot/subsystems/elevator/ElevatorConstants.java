...
public class ElevatorConstants { // TODO: check real values
    ...
    public static final MutableMeasure<Dimensionless> HEIGHT_THRESHOLD = Units.Percent.of(2).mutableCopy();
    public static final MutableMeasure<Dimensionless> STOPPER_THRESHOLD = Units.Percent.of(2).mutableCopy();

    public static final double MAX_VELOCITY = 3;
    public static final double MAX_ACCELERATION = 7;

    public static final Measure<Distance> GRIPPER_TO_HOOKS = Units.Meters.of(0.3); // [m]
